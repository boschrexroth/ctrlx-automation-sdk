...
The sample demonstrates how to use bulk operations, processing multiple values of the __ctrlX Data Layer__ in a single method call.
...
* Check trace output: `sudo snap logs -f sdk-cpp-client-bulk`
