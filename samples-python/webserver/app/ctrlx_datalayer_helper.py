...
For ease of use, the default values for IP address, user, password and SSL port are choosen to match the settings of a
...
def get_connection_string(
    ...
    @param[in] ssl_port Port number for a SSL connection. ctrlX COREvirtual with port forwarding: Use the host port (default 8443) forwarded to port 22 of the ctrlX CORE virtual.
