...
root_node = "sdk/cpp/datalayer/provider/alldata"
...
class CallDataLayerClient:
    ...
    def read(self):
        ...
        logging.info("read_async() %s", address)
        result = self.client.read_async(address, self.read_async_callback, 239)
    ...
    def create_async_callback(
        ...
        self.waiting_for = None
        logging.info(">>>create_async_callback(): %s %s %s", result, data, userdata)
    ...
    def create(self):
        ...
        def set_flatbuffers(self, data: bytearray) -> Result:
            ...
            data.set_array_int64([-9223372036854775807, -1, 0, 9223372036854775807])
    ...
    def remove(self):
        ...
        with Variant() as data:
            ...
            result = self.client.remove_async(address, self.remove_async_callback, 243)
            self.log_result("remove_async()", result)
            self.wait_for_async_callback(result)

    def browse_async_callback(
        self,
        result: Result,
        data: Variant,
        userdata: ctrlxdatalayer.clib.userData_c_void_p,
        ...
        self.waiting_for = None
        logging.info(
            ">>>browse_async_callback: %s %s %s",
            result,
            data.get_array_string(),
            userdata,
        )
    ...
    def browse(self):
        ...
        with data:
            ...
            result = self.client.browse_async("", self.browse_async_callback, 262)
            self.log_result("browse_async()", result)
            self.wait_for_async_callback(result)

    def write_async_callback(
        self,
        result: Result,
        data: Variant,
        userdata: ctrlxdatalayer.clib.userData_c_void_p,
    ...
    def print_metadata(self, text: str, result: Result, data: Variant):
        ...
        metadata = Metadata.Metadata.GetRootAsMetadata(data.get_flatbuffers(), 0)
    ...
    def metadata(self):
        ...
        result = self.client.metadata_async(address, self.metadata_async_callback, 490)
