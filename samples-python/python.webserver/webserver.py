...
class Server(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # HTML
            ...
            permissions_json = webtoken.checkPermissions(token,scopes_list)
    ...
    def do_POST(self):
        ...
        if data['submit'][0] == 'Read Value':
            ...
            if 'node' in data:
                ...
                # Data Layer access
                Server.readResult,Server.readValue = datalayerclient.read_node(Server.readPath)
        ...
        if data['submit'][0] == 'Write Value':
            ...
            if 'node' in data and 'value' in data:
                ...
                # Data Layer access
                Server.writeResult = datalayerclient.write_node(Server.writePath,Server.writeValue)
