...
Nodes should refer to a resource that is a thing (noun) instead of referring to
...
Paths should not be used to indicate that a CRUD (Create/Read/Update/Delete)
